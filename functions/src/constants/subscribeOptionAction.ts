const SUBSCRIBE_OPTION_PREFIX = "SUBSCRIBE_OPTION" as const;

enum SubscribeOptionAction {
...
export type SubscribeOptionActionId =
  typeof subscribeOptionActionId[keyof typeof subscribeOptionActionId];